...
def run():
    ...
    "Como te gustaria ingresar la información?",
    ...
    if add_selectbox == 'En linea':
        ...
        servicio = st.number_input('Hace cuanto trabaja para la compañia', min_value=1, max_value=37, value=25)
        ...
        if st.button("Predict"):
            ...
            st.write('Result: {}'.format(prediccion))     
